...
<body>
    <div class="container">
        ...
        <form action="proses_get.php" method="GET">
            <label>NIM :</label>
            <input type="text" name="nim" placeholder="e.g., 1234567890" required>

            <label>Nama :</label>
            <input type="text" name="nama" placeholder="e.g., John Doe" required>

            <label>Umur :</label>
            <input type="number" name="umur" placeholder="e.g., 20" required>

            <label>Tempat Lahir :</label>
            <input type="text" name="tempat_lahir" placeholder="e.g., Semarang" required>

            <label>Tanggal Lahir :</label>
            <input type="date" name="tanggal_lahir" required>

            <label>No HP :</label>
            <input type="text" name="no_hp" placeholder="e.g., 08123456789" required>

            <label>Alamat :</label>
            <textarea name="alamat" rows="4" placeholder="Enter your address..." required></textarea>
